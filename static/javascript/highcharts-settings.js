...
/** Highcharts Settings To Gallery from highcharts.html **/
    ...
    Dashboard.Helpers.elementExists('.highcharts-community-stat', function() {
        $(this).highcharts({
            chart: {
                renderTo: 'container',
                backgroundColor: 'transparent',
    ...
    Dashboard.Helpers.elementExists('.highcharts-community-complaint', function() {
        $(this).highcharts({
            chart: {
                type: 'column',
                height: 300
            ...
            tooltip: {
                ...
                pointFormat: '{series.name}: {point.y}<br/>总数: {point.stackTotal}'
            },
            plotOptions: {
                column: {
                    stacking: 'normal'
